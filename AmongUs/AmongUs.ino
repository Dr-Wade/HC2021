...
bool shoot(int T, int leg)
{

    int AMP = 35;
    int move1[] = {90 - 2 * AMP, 90 - AMP, 90, 90};
    int move2[] = {90, 90 - AMP, 90 - 90, 90};
    int move3[] = {90 + 80, 90 - AMP, 90 - 90, 90};
    int move4[] = {90, 90 - AMP, 90 - 90, 90};
    int move5[] = {90, 90 - AMP, 90, 90};
    int move6[] = {90, 90, 90, 90};

    int move21[] = {90 - AMP, 90 - 2 * AMP, 90, 90};
    int move22[] = {90 -AMP , 90, 90, 90 - 90};
    int move23[] = {90 - AMP, 90 + 80, 90, 90 - 90};
    int move24[] = {90 - AMP, 90, 90 - 90};
    int move25[] = {90- AMP , 90, 90, 90};
    int move26[] = {90, 90, 90, 90};

    if (leg == 1) //Walking forward
    {
      if (
          moveNServos(T * 0.2, move1) ||
          delays(t / 10) ||
